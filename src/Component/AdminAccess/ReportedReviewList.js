...
class ReportedReviewList extends Component {
    constructor(props) {
      super(props);
  ...
  componentDidMount() {
    DataService.getReportedReviews().then((res) =>{
...
export default withStyles(useStyles,{withTheme:true})(ReportedReviewList);
